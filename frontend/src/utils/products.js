...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Enjoy free shipping on all orders with no hidden charges.",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Make purchases with secure and trusted payment methods.",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Secure Payment",
    subtitle: "Your transactions are encrypted and protected for safety.",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: " Back Guarantee",
    subtitle: "Hassle-free returns and refunds if you're not satisfied.",
    bg: "#d6e5fb",
  },
];
...
export const discoutProducts = [
  {
    ...
    description:
      "Transform your living space with the Stone and Beam Westview Sofa, a perfect blend of modern aesthetics and cozy comfort",
    reviews: [
      {
        rating: 4.7,
